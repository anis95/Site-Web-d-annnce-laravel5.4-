      ...
      <div class="css-table">
        <div class="css-table-cell">
          <div class="welcome-logo">
            <img src="{!! asset('img/utilisateur.jpg') !!}" alt="">
          </div>
          
          
          <div class="welcome-content">
           
            <h5>Bienvenu <strong>{!! $user->name !!}  </strong></h5>
            <p>Vous trouverez ici toutes les annonces que vous avez déposez ! </p>
  ...
  <div class="main-content">
    ...
    <div class="companies-sliders">
      <div class="container">
        ...
        <h5 class="companies-slider-title"><strong>Mes Annonces</strong></h5>
        <div class="row">
